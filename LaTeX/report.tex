		...
		\begin{subfigure}{.5\textwidth}
			...
			\begin{tikzpicture}
				\begin{axis}[
					...
					\addplot table [x=P1, y=$x1$]{data/resRCW-WH-10-40-200-PercentageVar.txt};
					%\addlegendentry{$x1$ series}
					\addplot table [x=P1, y=$x1$]{data/resRCW-WH-10-40-200-PercentageVar (1).txt};
					\addplot table [x=P1, y=$x1$]{data/resRCW-WH-10-40-200-PercentageVar (2).txt};
				\end{axis}
			\end{tikzpicture}
			\caption{Objective}
		\end{subfigure}%
		\begin{subfigure}{.5\textwidth}
			...
			\begin{tikzpicture}
				\begin{axis}[
					...
					\addplot table [x=P1, y=$x2$]{data/resRCW-WH-10-40-200-PercentageVar.txt};
					%\addlegendentry{$x1$ series}
					\addplot table [x=P1, y=$x2$]{data/resRCW-WH-10-40-200-PercentageVar (1).txt};
				\end{axis}
			\end{tikzpicture}
		...
		\begin{subfigure}{.5\textwidth}
			...
			\begin{tikzpicture}
				\begin{axis}[
					xlabel=Allowed waiting time(\% of an hour),
					ylabel=Objective value]
					\addplot table [x=P1, y=$x1$]{data/resRCW-WH-10-40-200-WTG.txt};
					%\addlegendentry{$x1$ series}
				\end{axis}
			\end{tikzpicture}
			\caption{Objective}
		...
		\begin{subfigure}{.5\textwidth}
			...
			\begin{tikzpicture}
				\begin{axis}[
					xlabel=Allowed waiting time(\% of an hour),
					ylabel=Execution time(s)]
					\addplot table [x=P1, y=$x2$]{data/resRCW-WH-10-40-200-WTG.txt};
				\end{axis}
			\end{tikzpicture}
			\caption{Execution time}
		\end{subfigure}
		...
		\begin{subfigure}{.5\textwidth}
			...
			\begin{tikzpicture}
				\begin{axis}[
					xlabel=Allowed waiting time(\% of an hour),
					ylabel=Objective value]
					\addplot table [x=P1, y=$x1$]{data/resRCW-WH-25-100-200-VarNUsers.txt};
					%\addlegendentry{$x1$ series}
				\end{axis}
			\end{tikzpicture}
			\caption{Objective}
		...
		\begin{subfigure}{.5\textwidth}
			...
			\begin{tikzpicture}
				\begin{axis}[
					xlabel=Allowed waiting time(\% of an hour),
					ylabel=Execution time(s)]
					\addplot table [x=P1, y=$x2$]{data/resRCW-WH-25-100-200-VarNUsers.txt};
				\end{axis}
			\end{tikzpicture}
			\caption{Execution time}
		\end{subfigure}
