...
it fits with people who periodically do the same circuit.
	...
	\begin{figure}[H]
		...
		\end{subfigure}
		\caption{Varying the waiting time random}
		\label{fig:var wt}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\begin{subfigure}{.5\textwidth}
			...
			\caption{Execution time}
		\end{subfigure}
		\caption{Varying the waiting time3}
		\label{fig:var pd}
	\end{figure}
	...
	%%%%%%%%%%%%%%%%%%%%%%%%% DEVIATION VALUE %%%%%%%%%%%%%%%%%%%%%%
	\section{Name of the experiment3}
	\subsection{Varying the deviation's value of the travel allowed}
	\subsection{Benchmarks}
	\subsection{Configuration}
	\subsection{Results}
	...
	%%%%%%%%%%%%%%%%%%%%% NUMBER OF USERS %%%%%%%%%%%%%%%%%%%%%%
	\section{Name of the experiment4}
