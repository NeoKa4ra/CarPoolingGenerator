...
public class Constants {
	// ****************** WAY ****************** //
	public final static int W = 0; // Going to work
	public final static int WH = 1; // Going to work and to home
	public final static int WS = 2; // Going to work with satellites
	public final static int WHS = 3; // Going to work and to home with satellites
